...
**Backward Compatibility:** If your existing data uses a single <|video|> placeholder for a top-level video entry (regardless of segments), the **mossvl_finetune/data.py** loader will automatically expand it to the correct number of placeholders during the pre-tokenization phase.
